...
<aside class="main-sidebar sidebar-dark-primary elevation-4 menu_lateral">
    ...
    <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Modulo</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Jose Ortiz</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a onclick="cargarContenido('content-wrapper','vistas/modulos/participantes.php')" class="nav-link" style="cursor: pointer;">
                        ...
                        <li class="nav-item">
                            <a onclick="cargarContenido('content-wrapper','vistas/modulos/actividades.php')" class="nav-link" style="cursor: pointer;">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Actividades</p>
                            </a>
                        </li>
